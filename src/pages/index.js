        ...
        <Layout className="pt-24">
          ...
          <div className="flex items-center justify-between w-full mt-24">
            ...
            <div className="w-2/3 mr-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 bg-white shadow-xl shadow-neutral-100 border p-5">
                <Differeciales
                  icon={<RocketIcon />}
          ...
          <div className="w-full relative py-10 px-20 mt-5 flex items-center justify-between rounded-2xl border border-solid border-dark bg-light ">
            <div
            ...
            <div className="px-20">
              <h3 className="text-dark text-4xl font-medium">
                Você se Interessou?
              </h3>
