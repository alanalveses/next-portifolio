...
const Certificates = ({ limit }) => {
  const certificates = [
    {
      ...
      github:
        "https://github.com/alanalveses/Certificados/blob/main/Curso%20Superior%20de%20Tecnologia%20em%20An%C3%A1lise%20e%20Desenvolvimento%20de%20Sistemas.pdf",
      img: certificateADS,
      date: "22 de dezembro de 2023",
    },
    {
      title:
        "Láurea Acadêmica de Melhor Desempenho do Segundo Semestre de 2023 de ADS",
      link: "https://github.com/alanalveses/Certificados/blob/main/laurea%20academica%20de%20melhor%20desempenho.pdf",
      type: "Centro Universitário das Faculdades Metropolitanas Unidas - FMU",
      github:
        "https://github.com/alanalveses/Certificados/blob/main/laurea%20academica%20de%20melhor%20desempenho.pdf",
    ...
    },
    {
      ...
      type: "Alura",
      github:
        "https://github.com/alanalveses/Certificados/blob/main/Curso%20UX%20Design_%20entenda%20a%20%C3%A1rea%20da%20User%20Experience%20-%20Alura.pdf",
    ...
    },
    {
      ...
      type: "Alura",
      github:
        "https://github.com/alanalveses/Certificados/blob/main/Curso%20React_%20desenvolvendo%20com%20JavaScript%20-%20Alura.pdf",
      img: certificateFull,
  ...
  const visibleCertificates = limit
  ...
  return (
    <>
      ...
      />
      <div className="flex flex-col lg:col-span-2 gap-20 mb-24 gap-y-32">
